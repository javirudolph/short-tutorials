...
```{r}
# This function returns the sum of the negative log likelihood for a beta binomial distribution consisting of n number of trials
...
# We randomly sample a value of p from a beta distribution for each individual using the true parameters a and b
P <- rbeta(n=n, shape1=a, shape2=b)
# And we calculate the survival for the individuals based on the that probability P following a binomial model.
